    ...
    >
      <el-form ref="addFormRef" label-width="100px">
        ...
        ><el-form-item label="3.3	长度:">
          <el-row :gutter="4">
            <el-col :span="12" >
              <el-input v-model="index" placeholder="总帧数"></el-input>
            </el-col>
          </el-row> </el-form-item
        ><el-form-item label="数据长度:">
          <el-row :gutter="4">
            <el-col :span="12" >
              <el-input v-model="dataLength" placeholder="总帧数"></el-input>
            </el-col>
          </el-row> </el-form-item
        ><el-form-item label="主备机状态:">
          <el-row :gutter="4">
            <el-col :span="12" >
              <el-input v-model="deviceStatus" placeholder="总帧数"></el-input>
            </el-col>
          </el-row> </el-form-item
        ><el-form-item label="消息种类:">
          <el-row :gutter="4">
            <el-col :span="12" >
              <el-input v-model="msgType" placeholder="总帧数"></el-input>
            </el-col>
          </el-row> </el-form-item
        ><el-form-item label="消息尾:">
          <el-row :gutter="4">
            <el-col :span="12" >
              <el-input v-model="dataTail" placeholder="总帧数"></el-input>
            </el-col>
          </el-row>
        </el-form-item>
