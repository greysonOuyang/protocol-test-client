      ...
      <el-main id="main">
        ...
        >
          ...
          <el-form-item :label="$t('requestType')">
            <el-radio-group
              v-model="requestData.requestType"
          ...
          <!-- MODBUS 相关-->
          <el-form-item
            v-if="requestData.requestType == 'ModBus'"
            :label="$t('requestUrl')"
            
          >
            <!-- 后续再支持TLS (Transport Layer Security) -->
            <!-- <el-col :xs="24" :sm="2">
							<el-form-item><el-checkbox v-model="requestData.isSSL">TLS</el-checkbox></el-form-item>
						</el-col> -->
            <el-col :xs="24" :sm="14">
              <el-form-item
                prop="host"
                :rules="[{ required: true, message: $t('tcpHostTips') }]"
              >
                <el-input
            ...
            <el-col :xs="24" :sm="7">
              <el-form-item
                ><el-input
                  ...
                  min="0"
                  max="65535"
                  :placeholder="$t('ModBusPortPlaceholder')"
                  v-model="requestData.port"
                ></el-input
              ></el-form-item>
            </el-col>
          </el-form-item>
          ...
          <!-- <div>
          <el-form-item
            :label="$t('customizeModBus')"
            v-if="requestData.requestType == 'MODBUS'"
          >
            <el-button type="primary" size="small" @click="addModBus"
              >添加</el-button
            >
            <el-button type="primary" size="small" @click="editModBus"
              >编辑</el-button
            >
          ...
          >
            <el-input
              :placeholder="$t('websocketUrlPlaceholder')"
              v-model="requestData.url"
            ></el-input>
          </el-form-item>
          <!-- TCP相关 -->
          ...
          >
            <el-col :xs="24" :sm="2">
              <el-form-item
                ><el-checkbox v-model="requestData.isSSL"
                  >SSL</el-checkbox
                ></el-form-item
              >
            </el-col>
          ...
          <el-form-item :label="$t('certSetting')" v-if="requestData.isSSL">
            ...
            >
              <el-button
                ...
                @click="$refs.readCertKey.click()"
                >{{ $t("btnReadCertKey") }}</el-button
              >
              <input
                type="file"
                style="display: none"
              ...
              <el-button
                type="primary"
                size="small"
                @click="$refs.readCertValue.click()"
                >{{ $t("btnReadCertValue") }}</el-button
              >
              <input
                type="file"
                style="display: none"
          ...
          <!-- WebSocket的版本 -->
          <el-form-item
            label="WebSocketVersion"
            v-if="requestData.requestType == 'WebSocket'"
          >
            <el-select
              v-model="requestData.webSocketVersion"
              placeholder="请选择"
              style="width: 100%;"
            >
          ...
          >
            <el-col :span="24">
              <el-form-item
                v-for="(item, index) in requestData.subProtocols"
                :key="item.key"
              >
                <el-col :xs="20" :sm="21"
                  ><el-input
                ...
                <el-col :xs="3" :sm="2">
                  <el-button
                    @click.prevent="removeSubProtocols(item)"
                    size="small"
                    type="danger"
            ...
            <el-col :span="24">
              <el-button type="primary" size="small" @click="addSubProtocols">{{
                $t("btnAdd")
              }}</el-button>
            </el-col>
          </el-form-item>
          ...
          >
            <el-col :span="24">
              ...
              >
                ...
                <el-col :xs="3" :sm="2">
                  <el-button
                    @click.prevent="removeHeader(item)"
                    size="small"
                    type="danger"
                    >{{ $t("btnRemove") }}</el-button
                  >
          ...
          >
            <el-input
              :placeholder="$t('requestServerNamePlaceholder')"
              v-model="requestData.serverName"
            ></el-input>
          </el-form-item>
          <!-- 请求的body内容 -->
          ...
          <el-form-item>
            <div style="display: flex;flex-wrap: wrap;">
              <div style="margin-right: 0.6rem">
                <el-checkbox
                  v-model="requestConfig.printResInfo"
                  :label="$t('requestConfigPrintInfo')"
                ></el-checkbox>
              </div>
              <div style="margin-right: 0.6rem;">
                <el-input
                  :placeholder="$t('requestConfigTimeout')"
                  type="number"
              ...
              <div style="margin-right: 0.6rem;">
                <el-checkbox
                  v-model="requestConfig.keepAlive"
                  :label="$t('requestConfigKeepAlive')"
                ></el-checkbox>
              </div>
              <div
                style="flex: 1;"
              ...
              >
                <el-input
                  :placeholder="$t('requestConfigPoolSize')"
                  type="number"
                  v-model.number="requestConfig.poolSize"
                ></el-input>
              </div>
            </div>
          </el-form-item>
          <el-form-item>
            ...
            <el-button type="primary" :loading="isExecuting" @click="execute">{{
              isExecuting ? $t("btnIsExecute") : $t("btnExecute")
            }}</el-button>
            <el-button v-show="isExecuting" @click="executeCancel">{{
              $t("btnCancel")
            }}</el-button>
          </el-form-item>
        </el-form>
          ...
          <div id="response-heander" :style="watchResponseHeaderColor">
            ...
            >
              ...
              <div class="response-header-body">
                <div style="line-height: 34px;" class="sm-margin-left-0x">
                  {{ $t("succee") }}:&nbsp;
                </div>
            ...
            >
              <div
                class="response-header-label"
                style="align-items: flex-start;"
              >
                <b style="line-height: 34px;">{{ $t("responseTimesCount") }}</b>
              </div>
              <div
                class="response-header-body"
      ...
      this.$refs.requestTable.validate((valid) => {
        if (valid) {
          ...
          this.websocket.onopen = () => {
            ...
            if (trData.requestType == REQUEST_TYPE_TCP | trData.requestType == REQUEST_TYPE_MODBUS) {
